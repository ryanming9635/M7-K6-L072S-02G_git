...
#define LOGO_ADDR			0
#ifdef AWT_ML072S
#define RATINGINFO_ADDR		(34)	//addr:210(8x1:8)
#else
...
#else
#define INPUTINFO_ADDR		0///24	// 9x1:9
	#ifdef AWT_ML072S
	#define INPUTINFO_MIRROR_ADDR	0//83	//william-v1.0-970804
	#else
	#define INPUTINFO_MIRROR_ADDR	73//83	//william-v1.0-970804
	#endif
#define INPUTINFO_WIDTH		40	// 9x1:9		//william-v1.0-971111
#endif
#define OSD_VLOSS_ADDR  33 
...
#ifdef AWT_ML072S
#define BARNUM_LENGTH 			4//ryan@20170821
#else
...
#define OSD_VLOSS_COLOR			BG_COLOR_CYAN    | CH_COLOR_WHITE
...
#ifndef AWT_ML072S
#define Jump_COLOR 				BG_COLOR_CYAN|CH_COLOR_GREEN			//william-v1.1-970827
#else
